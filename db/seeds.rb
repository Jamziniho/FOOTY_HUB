...
game_5.user = user_5
p_1 = Player.create!(user: user_9, game: game_5, team: 2)
p_2 = Player.create!(user: user_8, game: game_5, team: 1)
p_3 = Player.create!(user: user_17, game: game_5, team: 2)
...
p_7 = Player.create!(user: user_18, game: game_5, team: 2)
...
p_11 = Player.create!(user: user_25, game: game_5, team: 1)
p_12 = Player.create!(user: user_24, game: game_5, team: 1)
p_13 = Player.create!(user: user_23, game: game_5, team: 2)
p_14 = Player.create!(user: user_22, game: game_5, team: 1)
